...
const {user_validator , login_validator ,search_all_employee_validator , search_employee_validator,update_employee_validator,delete_employee_validator, ValidatorResult} = require('../../validation/user.validator');


router.post('/signUp', user_validator ,  ValidatorResult ,  add_employee);
...
router.get('/search_one_by_employee' ,search_employee_validator , ValidatorResult, search_employee)
